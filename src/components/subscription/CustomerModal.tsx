        ...
        <div className="flex-1 overflow-auto p-4">
          ...
          {activeTab === 'actions' && (
            <div className="space-y-3">
              ...
              <button onClick={() => setShowChangePlan(true)} className="w-full py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-bold flex items-center justify-center gap-2"><RefreshCw className="w-5 h-5" />شراء خطة</button>
