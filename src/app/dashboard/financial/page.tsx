      ...
      <header className="bg-white shadow-sm sticky top-0 z-40">
        <div className="px-4 py-3 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Ø¹Ø±Ø¶ ÙˆØªØ­Ù„ÙŠÙ„ Ø§Ù„Ø£Ø¯Ø§Ø¡ Ø§Ù„Ù…Ø§Ù„ÙŠ Ù„Ù†Ø´Ø§Ø·Ùƒ Ø§Ù„ØªØ¬Ø§Ø±ÙŠ</p>
          </div>
        </div>
      </header>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-gray-900">Ø¥Ø­ØµØ§Ø¦ÙŠØ§Øª Ø§Ù„Ø¥ÙŠØ±Ø§Ø¯Ø§Øª</span>
            </div>
            <span className="text-xs text-gray-500">ØªØªØ¨Ø¹ Ø§Ù„Ù…Ø¨ÙŠØ¹Ø§Øª</span>
          </div>
              ...
              <div key={i} className="flex-1 flex flex-col items-center gap-1">
                <div className="w-full flex gap-0.5 items-end h-36">
                  ...
                  <div 
                    ...
                    title={`Ø¥ÙŠØ±Ø§Ø¯Ø§Øª: ${day.revenue.toFixed(3)}`}
                  ></div>
                  {/* Expense Bar */}
                  <div 
          ...
          <div className="flex justify-between mt-3 pt-3 border-t border-gray-100">
            <div className="text-sm">
              <span className="text-gray-500">Ø¥Ø¬Ù…Ø§Ù„ÙŠ Ø§Ù„Ø¥ÙŠØ±Ø§Ø¯Ø§Øª</span>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-4 border border-orange-200">
            <div className="flex items-center justify-between">
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-gray-500">{debtMembers.length} Ø¹Ù…ÙŠÙ„</div>
              </div>
            </div>
